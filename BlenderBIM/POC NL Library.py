...
class LibraryGenerator:
    def generate(self):
        ...
        self.project = ifcopenshell.api.run(
            "root.create_entity", self.file, ifc_class="IfcProject", name="BlenderBIM NL Library"
        )
        self.library = ifcopenshell.api.run(
            "root.create_entity", self.file, ifc_class="IfcProjectLibrary", name="BlenderBIM NL Library POC"
        )
        ...
        self.file.write("IFC4 NL Demo Library.ifc")
